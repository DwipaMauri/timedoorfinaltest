<template>
  <form @submit.prevent="addNewSmartphone" class="py-5 my-5 mx-5">
    <div class="mb-3">
...
const addNewSmartphone = async () => {
  await store.dispatch("smartphone/addNewSmartphone", smartphoneData.value);
